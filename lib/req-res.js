...
module.exports = function ReqRes ( reqResOptions ) {
	...
	function Requester ( options ) {
		Rabbus.Requester.call( this, Rabbit, mixins.getProducerOptions( options, 'req-res' ) );
	}
	...
	function Responder ( options ) {
		...
		Rabbus.Responder.call( this, Rabbit, mixins.getConsumerOptions( options, 'req-res' ) );
